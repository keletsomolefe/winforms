...
namespace Hawks_Business_Solutions
{
    public partial class AddSupplier : Form
    {
        ...
        public AddSupplier(Form callingForm)
        {
        ...
        private void textBox1_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                e.Cancel = true;
                errorProvider.SetError(textBox1, "Please enter supplier name");
            }
            else
            {
                e.Cancel = false;
        ...
        private void textBox3_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                e.Cancel = true;
                errorProvider.SetError(textBox3, "Please enter supplier phone number");
            }
            else
            {
                e.Cancel = false;
        ...
        private void textBox11_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                e.Cancel = true;
                errorProvider.SetError(textBox11, "Please enter bank");
            }
            else
            {
                e.Cancel = false;
                errorProvider.SetError(textBox11, null);
            }
        }
        ...
        private void textBox10_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                e.Cancel = true;
                errorProvider.SetError(textBox10, "Please enter account number");
            }
            else
            {
                e.Cancel = false;
                errorProvider.SetError(textBox10, null);
            }
        }
        ...
        private void textBox4_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                e.Cancel = true;
                errorProvider.SetError(textBox4, "Please enter branch code");
            }
            else
            {
                e.Cancel = false;
